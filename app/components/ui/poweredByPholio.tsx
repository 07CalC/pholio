export const PoweredByPholio = () => {
  return (
      ...
      <div
        className={`fixed gap-x-1 flex font-semibold font-mono box-decoration-slice drop-shadow-xl self-center md:self-start py-2 text-sm text-end text-black md:ml-5 bottom-0 mb-5 bg-gradient-to-br from-[#9df89f] to-[#4b67da] rounded-xl px-2 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_5px_#08f,0_0_10px_#08f] hover:shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_25px_#08f]`}
      >
        <a
